...
const port = process.env.FRONTEND_PORT; // Use PORT from .env if available, otherwise default to 3000
// Isn't working if the or isn't included. Not reading the .env component. Why? 
